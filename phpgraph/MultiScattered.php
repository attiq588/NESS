 ...
 <head><title>SVGGraph example</title></head>
	<body background="Pictures/b_g.jpg">
	 <h1><font color="white" style="position:absolute;top:10px;left:600px;width:550px;height:400px;z-index:999;position:fixed;">MultiScattered Graph</font>  </h1>
...
//                    echo('</ul>');
   ...
   //$g->$value2;
    ...
    $g->Text_H($label);
    $g->Text_V('10%','20%','30%','40%','50%');
    echo $g->Fetch('MultiScattered');

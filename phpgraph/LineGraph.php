...
<head><title>SVGGraph example</title></head>
	<body background="Pictures/b_g.jpg">
	 <h1><font color="white" style="position:absolute;top:10px;left:600px;width:550px;height:400px;z-index:999;position:fixed;">Line Graph</font>  </h1>
...
//                    echo('</ul>');
    ...
    $g->Text_H($t);
		$g->Text_V('50','100','150','200','250','300','350','400');
		echo $g->Fetch('LineGraph');
		return $data;
		}
?>

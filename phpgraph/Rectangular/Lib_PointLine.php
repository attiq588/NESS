...
Class PointLine extends Graph{ 
	...
	function Draw() {
        ...
        $var_2 .= "<marker id = \"circle\" viewBox = \"0 0 12 12\" 
					refX = \"15\" refY = \"8\" markerWidth = \"9\" markerHeight = \"9\" stroke = \"black\" 
					stroke-width = \"2\" fill = \"black\" orient = \"auto\">";
		...
		$var_2 .= "\n<g transform=\"translate(10,370) scale(1,-1)\" >";
			...
			for ($i=0; $i<$n1 ; $i++)
				...
				$var_2 .= "\" style=\"fill: none; stroke:black;\" />\n";
